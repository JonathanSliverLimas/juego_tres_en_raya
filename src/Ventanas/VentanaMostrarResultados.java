...
public class VentanaMostrarResultados extends javax.swing.JDialog {
    ...
    private int vecesGano1, vecesGano2, vecesEmpates;
    
    

    public VentanaMostrarResultados(java.awt.Frame parent, boolean modal, String usuario1, String usuario2, int vecesGano1, int vecesGano2, int vecesEmpates) {
        super(parent, modal);
        this.usuario1 = usuario1;
        this.usuario2 = usuario2;
        this.vecesGano1 = vecesGano1;
        this.vecesGano2 = vecesGano2;
        this.vecesEmpates = vecesEmpates;
    ...
    private void cargarDatosTabla(){
        modeloTabla.addColumn(usuario1);
        modeloTabla.addColumn(usuario2);
        modeloTabla.addColumn("Nº de empates");
        
        String fila[] ={String.valueOf(vecesGano1), String.valueOf(vecesGano2), String.valueOf(vecesEmpates)};
